...
use crate::filters::DarkLightFilter;
use crate::wallpaper::WallpaperMode;

/// The dark/light mode setting to apply
...
fn default_dark_mode_setting() -> DarkLightFilter {
    DarkLightFilter::None
}
...
struct Cli {
    ...
    #[arg(long)]
    dark_mode: Option<DarkLightFilter>,
