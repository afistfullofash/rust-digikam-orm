//! The schema of the DigiKam Database
//!
//! This has been generated by:
//!   - running: `sqlite3 <path/to/digikam/database> .schema`
//!   - putting the resulting output into ../migrations/2026-03-10-020327-0000_schema/
//!   - running: `diesel migration run`
//!   - adding:
//!     - diesel::joinable!
//!
//!  Further changes will first need the joinable clauses fixed to be perminate
